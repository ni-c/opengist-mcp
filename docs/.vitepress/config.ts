...
const site = 'https://opengist-mcp.ni-c.de';
const description =
  'An MCP server for Opengist, the self-hosted pastebin powered by Git';
...
export default defineConfig({
  ...
  head: [
    ...
    ['meta', { property: 'og:site_name', content: 'opengist-mcp' }],
    ['meta', { property: 'og:title', content: 'opengist-mcp' }],
  ...
  themeConfig: {
    ...
    nav: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            text: 'Releases',
            link: 'https://github.com/ni-c/opengist-mcp/releases',
          },
          {
            text: 'npm package',
            link: 'https://www.npmjs.com/package/opengist-mcp',
          },
        ],
      },
    ],
      ...
      '/guide/': [
        {
          text: 'Introduction',
          items: [
            { text: 'What is opengist-mcp?', link: '/guide/' },
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/ni-c/opengist-mcp' },
    ...
    editLink: {
      pattern: 'https://github.com/ni-c/opengist-mcp/edit/main/docs/:path',
